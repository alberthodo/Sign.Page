-- Prefer explicit deliverable (tab) over token-scoped folder when listing/posting threads.
...
BEGIN
  ...
  -- Tab selection (project/selection links) must win over a stale token.folder_id.
